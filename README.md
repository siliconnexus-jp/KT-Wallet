...
| KT Gateway | `1.16.20` | Production service at `https://gateway.kt-wallet.com` |

Gateway source version: `1.16.20` (deployed to both production instances on
2026-08-04 after the reviewed EVM dynamic-fee rollout gates passed).
...
Gateway `1.16.20` currently exposes 16 mainnet/testnet network profiles. It uses
...
issues: **1,562/1,562** KT Wallet tests, **570/570** KT Cold Signer tests, and
**426/426** shared-package tests passed. The default gate passed **12/12** and
