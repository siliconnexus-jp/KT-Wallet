...
| KT Gateway | `1.16.29` | Production service at `https://gateway.kt-wallet.com` |

Gateway source version: `1.16.29`. This version is deployed to the production
gateway behind `https://gateway.kt-wallet.com`; TronGrid credentials remain server-side.
...
Gateway `1.16.29` currently exposes 16 mainnet/testnet network profiles. It uses
