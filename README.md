...
| KT Gateway | `1.16.19` | Production service at `https://gateway.kt-wallet.com` |

Gateway source version: `1.16.19` (deployed to both production instances on
2026-08-04 after the reviewed Solana transaction-status rollout gates passed).
...
Gateway `1.16.19` currently exposes 16 mainnet/testnet network profiles. It uses
...
issues: **1,531/1,531** KT Wallet tests, **570/570** KT Cold Signer tests, and
**415/415** shared-package tests passed. The default gate passed **12/12** and
