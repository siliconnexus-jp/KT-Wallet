...
| KT Gateway | `1.16.27` | Production service at `https://gateway.kt-wallet.com` |

Gateway source version: `1.16.27`. The same reviewed version is deployed to
both production instances behind `https://gateway.kt-wallet.com`.
...
Gateway `1.16.27` currently exposes 16 mainnet/testnet network profiles. It uses
