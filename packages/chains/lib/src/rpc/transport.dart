...
RpcRejectionKind publicRpcRejectionKind(Object? message) {
  ...
  const known = <(String, RpcRejectionKind)>[
    ...
    ('already been processed', RpcRejectionKind.alreadyKnown),
    ('already processed', RpcRejectionKind.alreadyKnown),
    ('transaction already exists', RpcRejectionKind.alreadyKnown),
    ('already imported', RpcRejectionKind.alreadyKnown),
