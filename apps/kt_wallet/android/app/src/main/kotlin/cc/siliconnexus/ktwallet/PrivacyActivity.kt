...
class PrivacyActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // If Android restored this Activity from a killed background process,
        // it has no earlier focus transition to tell us that the task was
        // selected. A focused page after this grace period is a return path.
    ...
    override fun onResume() {
        super.onResume()
        // Android can create this Activity after the task has already lost
        // focus, so no initial focus-loss callback is guaranteed. A first
        // resume well after creation means the user selected the task again.
