...
/// logged, and the temporary vault entry is deleted in finally. No RPC or
/// funded account is involved.
void main() {
  IntegrationTestWidgetsFlutterBinding.ensureInitialized();

  test(
    'native Wallet Core emits canonical EVM and TRON signatures',
    () async {
      const walletId = 'native-canonicality-test';
