...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get walletUnlockRequired => 'Wallet locked';

  @override
  String get walletUnlockRequiredDesc =>
      'System authentication is required to read your wallet. Cancelling or expired authentication does not delete it. Unlock to retry.';

  @override
  String get walletUnlockAction => 'Authenticate and unlock';

  @override
  String get signerBackupScope =>
      'Backs up this wallet’s recovery phrase only, not the app PIN, settings or signing history.';

  @override
  String get signerBackupLocalWarning =>
      'The QR and password together unlock your recovery phrase. Save locally, disable cloud sync and store the password separately. A lost password cannot be recovered.';

  @override
  String get signRejectWallet =>
      'This request belongs to another cold wallet. Pair the current cold wallet again on the online device, then create a new transaction QR.';

  @override
  String get signRejectExpired =>
      'This request has expired. Create a new transaction QR on the online device.';

  @override
  String get signRejectClock =>
      'The device clocks do not match. Check system time and create a new request.';

  @override
  String get signRejectDuplicate =>
      'This request was already processed or reserved and cannot be signed again. Check signing records.';

  @override
  String get signRejectUnsupported =>
      'The transaction cannot be parsed safely or its network does not match. Only native transfers, token transfers and approve(spender, 0) revocations are supported.';

  @override
  String get signRejectInvalid =>
      'This QR is not a valid signing request. Scan the transaction QR generated by the online wallet.';

  @override
  String get signRejectNoWallet =>
      'No cold wallet is available. Create or import a wallet and pair it again.';

  @override
  String get signRejectStorage =>
      'The secure signing records could not be read. Go back and try again.';

  @override
  String get signRejectNoSignature =>
      'This request was not signed. See the reason below.';

  @override
  String get amountPrecisionUnknown =>
      'Token precision is unverified. Check the raw amount and contract address.';
