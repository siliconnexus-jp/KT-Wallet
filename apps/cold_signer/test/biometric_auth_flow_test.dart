...
void main() {
  ...
  Future<void> openC8(WidgetTester tester, {SignerWalletController? wallet}) async {
    tester.platformDispatcher.localesTestValue = <Locale>[const Locale('zh')];
    addTearDown(tester.platformDispatcher.clearLocalesTestValue);
    await tester.pumpWidget(wallet == null
        ? ColdSignerApp()
  ...
  testWidgets('biometric success authorizes the signature (same as PIN success)',
      (tester) async {
